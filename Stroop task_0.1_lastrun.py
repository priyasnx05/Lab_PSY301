...
expName = 'Stroop task_0.1'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ps\\OneDrive\\Desktop\\priya\\Ahmedabad University\\Psy LAB\\Stroop Task(Exp1)\\Stroop task_0.1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome. You are required to Press 'r' key if the color of the text is red, and 'b' key if the color of the text is blue. Press 'SPACE' to start",
        font='Arial',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Thankyou for taking part in the experiment.',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Stroop task variables cond.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        Stimulus.setColor(Color, colorSpace='rgb')
